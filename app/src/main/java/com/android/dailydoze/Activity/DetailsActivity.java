...
import com.android.dailydoze.Utility.Details;
...
public class DetailsActivity extends AppCompatActivity {
    private EditText name, phone, country, city, state, zip, address, blood, medical, other, height, weight, bp;
    RelativeLayout dob;
    Spinner gender, type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(userName) || TextUtils.isEmpty(userPhone) || TextUtils.isEmpty(userDOB) || TextUtils.isEmpty(userCity)
                    || TextUtils.isEmpty(userState) || TextUtils.isEmpty(userCountry) ||
                ...
                addUser(userName, userPhone, userGender, userDOB, userCountry,
    ...
    private void addUser(String name, String phone, String gender, String dob,
        ...
        databaseReference.child("users").orderByChild("phone").equalTo(phone).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    submit.setText("Details Already Submitted.");
                } else {
    ...
    private class LocationAddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == 1) {
                Toast.makeText(DetailsActivity.this, "Address not found., ", Toast.LENGTH_SHORT).show();
            }
    ...
    private void getAddress() {
        if (!Geocoder.isPresent()) {
            Toast.makeText(DetailsActivity.this, "Can't find the current address. ",
